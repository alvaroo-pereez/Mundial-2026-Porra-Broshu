...
DEFAULT_CFG: dict[str, Any] = {
    ...
    "eliminatorias": {
        ...
        "diferencia": 4,
        "clasificado": 3,
        "empate_exacto_falla_clasificado": 4,
        "empate_diferencia_acierta_clasificado": 4,
...
def run_self_tests() -> None:
    ...
    cases = [
        ...
        ("Octavos", 2, 1, 2, 1, "Local", "Local", 8),
        ("Octavos", 3, 1, 2, 0, "Local", "Local", 4),
        ("Octavos", 2, 0, 1, 1, "Local", "Local", 3),
        ("Octavos", 2, 0, 1, 1, "Local", "Visitante", 0),
        ("Dieciseisavos", 1, 1, 1, 1, "Local", "Local", 8),
        ("Dieciseisavos", 1, 1, 1, 1, "Local", "Visitante", 4),
        ("Dieciseisavos", 2, 2, 1, 1, "Local", "Local", 4),
        ("Dieciseisavos", 2, 2, 1, 1, "Visitante", "Local", 2),
        ("Dieciseisavos", 2, 1, 1, 1, "Local", "Local", 3),
    ]
